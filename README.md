...
## [Project 1: Use of Unsupervised Machine Learning Algorithms to classify the appropriate Index of Biotic Integrity](https://gitlab.com/sugar_stats/pmi-cpmi-striation)
...
This data was pulled on 5/8/2023. This should not be the sole source of investing information, and should be double checked with other sources due the lack of reliability that the yfinance package sometimes displays. All investment decisions should be discussed with your financial adviser. 
